class RomanNumber():
    ...
    def __eq__(self, otrovalor):
        ...
        raise ValueError("{} solo puede ser entero, cadena, flotant o RomanNumber".format(otrovalor))
